...
Revision ID: 7246b26025e9
Revises: 
Create Date: 2025-06-27 14:22:24.188010
...
def downgrade() -> None:
    ...
    if 'projects' in existing_tables:
        ...
        # Drop projects table if it has no other columns we need to preserve
